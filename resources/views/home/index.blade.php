...
<div class=" p-5 rounded my-5 shadow " style="background-color:rgba(255, 255, 255, 0.5);">
        ...
        <div class="content text-center">
            ...
            <div class="row center d-flex justify-content-around">
                ...
                <div class="col-sm col-md-3 bg-white shadow mx-3 my-3 rounded align-center">
                    ...
                    <div class="center my-4 mx-4" style=""><img src="{{ $product->image }}" width="156" height="216"
                            alt=""></div>
                    <div class="caption">
                        ...
                        <div>
                            ...
                            <div class="mx-3 my-3 ">
                                <p class="book-font"><strong>Stock: </strong>{{ $product->quantity_stock }}</p>
                            </div>
                            <div class="flex-1 " stlye="min-height: 1rem;"></div>
                            <div class="price book-font mx-3 rounded  "
                                style="box-shadow: 0 2px 5px 0 rgba(0,0,0,.2);text-align:center; background-color:#4DD197; color:white ">
                                <p>Price: {{ $product->buy_price }}฿</p>
                            </div>
                            <p class="btn-holder"><a href="{{ route('add.to.cart', $product->ISBN) }}"
                                    class="btn btn-block text-center" style="background-color:#D98481; color:white" role="button"><strong>Add to cart</strong></a> </p>
    ...
    @guest
    <div class="justify-content-center text-center">
        <h1 class="justify-content-center book-font">Homepage</h1>
    </div>
                ...
                <div class="col-sm col-md-3 bg-white shadow mx-3 my-3 rounded align-center">
                    ...
                    <div class="caption">
                        ...
                        <div>
                            ...
                            <div class="price book-font mx-3 rounded  "
                                style="box-shadow: 0 2px 5px 0 rgba(0,0,0,.2);text-align:center; background-color:#4DD197; color:white ">
                                <p><strong>Price: {{ $product->buy_price }}฿</strong></p>
                            </div>
                        </div>
                    </div>
                    <!-- </div> -->
